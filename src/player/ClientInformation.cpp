...
const std::string &ClientInformation::get_locale() const {
    return m_locale;
}
...
int8_t ClientInformation::get_view_distance() const {
...
int32_t ClientInformation::get_chat_mode() const {
    return m_chat_mode;
}
...
int32_t ClientInformation::get_main_hand() const {
    return m_main_hand;
}
