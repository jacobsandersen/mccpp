...
std::shared_ptr<TagListBuilder> TagListBuilder::create(TagType list_type) {
    return create(L"", std::move(list_type));
}

std::shared_ptr<TagListBuilder> TagListBuilder::create(std::wstring name, TagType list_type) {
...
std::shared_ptr<TagListBuilder> TagListBuilder::add_string(std::wstring value) {
