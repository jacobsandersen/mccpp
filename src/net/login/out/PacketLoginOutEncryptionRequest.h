...
public:
    PacketLoginOutEncryptionRequest(std::string server_id, int32_t public_key_length, int8_t *public_key_bytes, int32_t verify_token_length, int8_t *verify_token_bytes) :
...
private:
    ...
    int8_t *public_key_bytes;
    int32_t verify_token_length;
    int8_t *verify_token_bytes;
};
