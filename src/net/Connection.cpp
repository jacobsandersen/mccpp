...
boost::asio::io_context& Connection::get_context() const { return m_context; }

boost::asio::ip::tcp::socket* Connection::get_socket() { return &m_socket; }

ByteBuffer& Connection::get_data_buffer() { return m_data_buffer; }

BufferReadContext& Connection::get_read_context() { return m_read_context; }
...
bool Connection::get_compress_packets() const { return m_compress_packets; }

void Connection::enable_compression() { m_compress_packets = true; }

bool Connection::get_encrypt_packets() const { return m_encrypt_packets; }
